...
#include "Naturesymphony/Inventory/Effects/Public/ItemEffect.h"
...
void UInventorySystemComponent::TransferSlots(int32 SourceIndex, UInventorySystemComponent* SourceInventory, int32 DestinationIndex)
{
